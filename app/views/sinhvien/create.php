...
<div style="margin-top: 20px; text-align: left; max-width: 500px;">
    <form action="/QLSINHVIEN/public/sinhvien/store" method="POST" style="padding: 20px; border: 1px solid #ccc; border-radius: 5px;">
        ...
        <div>
            ...
            <a href="/QLSINHVIEN/public/sinhvien" style="margin-left: 10px; text-decoration: none; color: #333; padding: 10px 20px; border: 1px solid #ccc; background-color: #f2f2f2;">Hủy</a>
        </div>
    </form>
</div>